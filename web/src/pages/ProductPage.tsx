                        ...
                        <form onSubmit={handleFormSubmit}>
                            <Grid>
                                <Grid.Col span={{ base: 12, md: 7 }}>
                                    ...
                                    <TextInput label="Preço de Venda Sugerido" placeholder="R$ 0,00" value={formatCurrency(formData.sale_price || 0)} onChange={(e) => setFormData(p => ({...p, sale_price: Number(e.target.value.replace(/\D/g, '')) / 100}))} mt="md" />
